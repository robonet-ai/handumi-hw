...
HandUMI is a hand-worn, open-source interface for collecting robot manipulation
demonstrations without a robot in the loop. It keeps the UMI idea of recording
robot-agnostic manipulation data, but replaces the handheld gripper with a
finger-worn device operated by natural thumb-index pinch motion.

<p align="center">
  <img src="../media/HandUMI.jpg" alt="HandUMI worn on the hand, with tracker and wrist-camera mounts" width="720">
</p>
...
<p align="center">
  <img src="../media/HandUMI-demo.gif" alt="HandUMI demo opening and closing by pinch" width="640">
</p>
